...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '3.0.0', __( 'WooCommerce KISSmetrics', 'woocommerce-kiss-metrics' ), __FILE__, 'init_woocommerce_kiss_metrics', array( 'minimum_wc_version' => '2.1', 'backwards_compatible' => '3.0.0' ) );
