...
<div class="landing">
    <div class="section section-cta section-odd">
        <div class="landing-container">
            <div class="premium-cta">
                <p>
                    <?php echo sprintf( __('Upgrade to %1$spremium version%2$s of %1$sYITH WooCommerce Affiliates%2$s to benefit from all features!','yith-wcaf'),'<span class="highlight">','</span>' );?>
                </p>
    ...
    <div class="one section section-even clear">
        ...
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_WCAF_URL?>assets/images/01.png" alt="<?php _e( 'PayPal','yith-wcaf') ?>" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_WCAF_URL?>assets/images/01-icon.png" alt="icon 01"/>
                    <h2><?php _e('PayPal','yith-wcaf');?></h2>
                </div>
                <p>
    ...
    <div class="two section section-odd clear">
        <div class="landing-container">
            ...
            <div class="col-1">
                <img src="<?php echo YITH_WCAF_URL?>assets/images/02.png" alt="<?php _e( 'Automatic payment','yith-wcaf') ?>" />
            </div>
        </div>
    </div>
    <div class="three section section-even clear">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_WCAF_URL?>assets/images/03.png" alt="<?php _e( 'Click Info','yith-wcaf') ?>" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_WCAF_URL?>assets/images/03-icon.png" alt="icon 03" />
                    <h2><?php _e( 'Click info','yith-wcaf');?></h2>
                </div>
                <p>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Commission rate','yith-wcaf');?></h2>
                </div>
                <p>
            ...
            <div class="col-1">
                <img src="<?php echo YITH_WCAF_URL?>assets/images/04.png" alt="<?php _e( 'Commission rate','yith-wcaf') ?>" />
            </div>
        </div>
    </div>
    <div class="five section section-even clear">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_WCAF_URL?>assets/images/05.png" alt="<?php _e( 'Permanent association','yith-wcaf') ?>" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_WCAF_URL?>assets/images/05-icon.png" alt="icon 05" />
                    <h2><?php _e('Permanent association','yith-wcaf');?></h2>
                </div>
                <p>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Affiliate history','yith-wcaf');?></h2>
                </div>
                <p>
            ...
            <div class="col-1">
                <img src="<?php echo YITH_WCAF_URL?>assets/images/06.png" alt="<?php _e( 'Mobile devices','yith-wcaf') ?>" />
            </div>
        </div>
    </div>
    <div class="seven section section-even clear">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_WCAF_URL?>assets/images/07.png" alt="<?php _e( 'Automatic approval','yith-wcaf') ?>" />
            </div>
            <div class="col-2">
                <div class="section-title">
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Click duration','yith-wcaf');?></h2>
                </div>
                <p>
            ...
            <div class="col-1">
                <img src="<?php echo YITH_WCAF_URL?>assets/images/08.png" alt="<?php _e( 'Click duration','yith-wcaf') ?>" />
            </div>
        </div>
    </div>
    <div class="nine section section-even clear">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_WCAF_URL?>assets/images/09.png" alt="<?php _e( 'Report','yith-wcaf') ?>" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_WCAF_URL?>assets/images/09-icon.png" alt="icon 09" />
                    <h2><?php _e('Report','yith-wcaf');?></h2>
                </div>
                <p>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Notification email','yith-wcaf');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __('Enjoy the benefits of notification emails that the plugin allows you to get in order to keep both administratore and users (affiliate and not) always updated.%3$sAny new %1$saffiliation request%2$s or %1$scommission payment%2$s will be notified via email in a dynamic site like yours!','yith-wcaf'),'<b>','</b>','<br>'); ?>
                </p>
            </div>
            <div class="col-1">
                <img src="<?php echo YITH_WCAF_URL?>assets/images/10.png" alt="<?php _e( 'Notification email','yith-wcaf') ?>" />
            </div>
        </div>
    </div>
    <div class="eleven section section-even clear">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_WCAF_URL?>assets/images/11.png" alt="<?php _e( 'Report','yith-wcaf') ?>" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_WCAF_URL?>assets/images/11-icon.png" alt="icon 09" />
                    <h2><?php _e('Affiliation code','yith-wcaf');?></h2>
                </div>
                <p>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php _e('Delete cookie','yith-wcaf');?></h2>
                </div>
                <p>
                    <?php echo sprintf( __('The user reached your site through an affiliation. %1$sFor how long will his/her purchases generate commissions for the affiliate?%2$s You can choose by setting a deadline or by making sure the affiliation will be deleted after the first purchase.','yith-wcaf'),'<b>','</b>'); ?>
                </p>
            </div>
            <div class="col-1">
                <img src="<?php echo YITH_WCAF_URL?>assets/images/10.png" alt="<?php _e( 'Notification email','yith-wcaf') ?>" />
