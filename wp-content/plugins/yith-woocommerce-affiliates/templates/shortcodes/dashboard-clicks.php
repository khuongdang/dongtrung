	...
	<table class="shop_table">
		...
		<tr>
			<th class="column-date">
				<a class="<?php echo ( $ordered == 'click_date' ) ? 'ordered to-order-' . strtolower( $to_order )  : '' ?>" href="<?php echo esc_url( add_query_arg( array( 'orderby' => 'click_date', 'order' => $to_order ) ) ) ?>"><?php _e( 'Date', 'yith-wcaf' ) ?></a>
			</th>
			<th class="column-status">
				<a class="<?php echo ( $ordered == 'order_id' ) ? 'ordered to-order-' . strtolower( $to_order )  : '' ?>" href="<?php echo esc_url( add_query_arg( array( 'orderby' => 'order_id', 'order' => $to_order ) ) ) ?>"><?php _e( 'Status', 'yith-wcaf' ) ?></a>
			</th>
