...
if( ! function_exists( 'yith_affiliates_constructor' ) ) {
	function yith_affiliates_constructor() {
		load_plugin_textdomain( 'yith-wcaf', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
...
if( ! function_exists( 'yith_wcaf_install_woocommerce_admin_notice' ) ) {
	function yith_wcaf_install_woocommerce_admin_notice() {
		?>
		<div class="error">
			<p><?php _e( 'YITH WooCommerce Affiliateas is enabled but not effective. It requires WooCommerce in order to work.', 'yith-wcaf' ); ?></p>
		</div>
	<?php
	}
}
...
if( ! function_exists( 'yith_wcaf_install_free_admin_notice' ) ){
	function yith_wcaf_install_free_admin_notice() {
		?>
		<div class="error">
			<p><?php _e( 'You can\'t activate the free version of YITH WooCommerce Affiliates while you are using the premium one.', 'yith-wcaf' ); ?></p>
		</div>
	<?php
	}
}