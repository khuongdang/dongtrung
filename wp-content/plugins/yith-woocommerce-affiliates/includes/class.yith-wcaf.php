	...
	class YITH_WCAF {
		...
		public function __construct() {
			...
			$this->_available_endpoints = apply_filters( 'yith_wcaf_available_endpoints', array(
				...
				'generate-link' => __( 'Generate Link', 'yith-wcaf' ),
			...
			$schedules = array_merge(
				...
				array(
					'weekly' => array(
						...
						'display' => __( 'Once a week', 'yith-wcaf' )
					),
					'monthly' => array(
						'interval' => DAY_IN_SECONDS * 30,
						'display' => __( 'Once a month', 'yith-wcaf' )
					)
				)
			);
		...
		protected function _install_tables(){
			...
			$sql = "CREATE TABLE IF NOT EXISTS $wpdb->yith_affiliates (
			...
			$sql = "CREATE TABLE IF NOT EXISTS $wpdb->yith_commissions (
                    ID bigint(20) NOT NULL AUTO_INCREMENT,
			...
			$sql = "CREATE TABLE IF NOT EXISTS $wpdb->yith_commission_notes (
                    ID bigint(20) NOT NULL AUTO_INCREMENT,
			...
			// adds clicks table
			$sql = "CREATE TABLE IF NOT EXISTS $wpdb->yith_clicks (
                    ID bigint(20) NOT NULL AUTO_INCREMENT,
                    affiliate_id bigint(20) NOT NULL,
			...
			// adds payments table
			$sql = "CREATE TABLE IF NOT EXISTS $wpdb->yith_payments(
                    ID bigint(20) NOT NULL AUTO_INCREMENT,
                    affiliate_id bigint(20) NOT NULL,
                    payment_email varchar(100) NOT NULL DEFAULT '',
			...
			$sql = "CREATE TABLE IF NOT EXISTS $wpdb->yith_payment_commission(
                    ID bigint(20) NOT NULL AUTO_INCREMENT,
			...
			// adds commission notes table
			$sql = "CREATE TABLE IF NOT EXISTS $wpdb->yith_payment_notes (
                    ID bigint(20) NOT NULL AUTO_INCREMENT,
                    payment_id bigint(20) NOT NULL,
                    note_content text NOT NULL,
                    note_date datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
		...
		protected function _install_pages(){
			$page = array(
				...
				'title' => __( 'Affiliate Dashboard', 'yith-wcaf' ),
