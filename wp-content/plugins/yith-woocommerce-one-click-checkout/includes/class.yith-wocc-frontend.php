	...
	class YITH_WOCC_Frontend {
		...
		public function one_click_handler() {
			...
			try{
				...
				$message = apply_filters( 'yith_wocc_success_msg_order_created', __( 'Thank you. Your order has been received and it is now waiting for payment', 'yith-woocommerce-one-click-checkout' ) );
