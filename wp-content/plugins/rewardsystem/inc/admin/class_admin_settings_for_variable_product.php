            ...
            if ($point_price_type == 2) {
                for ($i = 0; $i < sizeof($variable_sku); $i++):
                    ...
                    if (isset($points_based_on_conversion[$i])) {
                        $newvalue = $points_based_on_conversion[$i] / get_option('rs_redeem_point_value');
                        $points_based_on_conversion[$i] = $newvalue * get_option('rs_redeem_point');
            ...
            if ($checkenable == '1') {
                if ($checkrule == '1') {
                    ...
                    if (get_option('rs_set_price_to_calculate_rewardpoints_by_percentage') == '1') {
                        ...
                        $variationregularprice = $variable_product1->_price;
