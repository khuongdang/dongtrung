        ...
        if (get_option('rs_enable_disable_point_priceing') == '1') {
            ...
            if (get_option('rs_enable_disable_point_priceing') == '1') {
                ...
                if ($typeofprice == '2') {
                    ...
                    if ($point_price != '') {
                        return $price . $point_price_info . $point_price;
                    } else {
                        return $price;
                    }
                }
                                            ...
                                            if (get_option('rs_message_position_in_single_product_page_for_simple_products') == '1') {
                                                if (get_option('rs_enable_disable_point_priceing') == '1') {
                                                    ...
                                                    if ($typeofprice == '2') {
                                                        ...
                                                        if ($point_price != '') {
                                                            return $stylerewardpoint . "<br>" . $price . $point_price_info . $point_price;
                                                        } else {
                                                ...
                                                if (get_option('rs_enable_disable_point_priceing') == '1') {
                                                    ...
                                                    if ($typeofprice == '2') {
                                                        ...
                                                        if ($point_price != '') {
                                                            return $price . $point_price_info . $point_price . "<br>" . $stylerewardpoint;
                                                        } else {
                                                ...
                                                if (get_option('rs_message_position_for_simple_products_in_shop_page') == '1') {
                                                    ...
                                                    if (get_option('rs_enable_disable_point_priceing') == '1') {
                                                        ...
                                                        if ($typeofprice == '2') {
                                                            ...
                                                            if ($point_price != '') {
                                                                return $price . $point_price_info . $point_price . "<br><small>" . $stylerewardpoint . "</small>";
                                                            } else {
                                                                return $price . "<br>" . $stylerewardpoint;
                                                            }
                                                        }
