...
class RSPointExpiry {
    ...
    public static function rs_insert_the_selected_level_revised_reward_points($pointsredeemed, $level, $productid, $variationid, $itemquantity, $orderuserid, $termid, $equearnamt, $equredeemamt, $order_id, $product_ids, $item) {
        ...
        if (get_option('rs_set_price_to_calculate_rewardpoints_by_percentage') == '1') {
            ...
            $getregularprice1 = RSFunctionForSavingMetaValues::rewardsystem_get_post_meta($productid, '_price');
            if ($getregularprice1 == '') {
                $getregularprice1 = RSFunctionForSavingMetaValues::rewardsystem_get_post_meta($productid, '_regular_price');
            }

            $getregularprice = $variationid == '0' || '' ? $getregularprice1 : $variationregularprice;
