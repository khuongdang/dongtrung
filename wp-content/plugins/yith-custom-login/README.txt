...
[use](http://yithemes.com/contact/ "Your Inspiration Themes") so we can bundle it into YITH Custom Login Languages.

== Documentation ==

Full documentation is available [here](http://yithemes.com/docs-plugins/yith_custom_login/).
